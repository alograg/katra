...
web build:
 - http://mootools.net/core/23264c6bc6c0f2b045c0b9f4fbdd6532

packager build:
 - packager build Core/Element.Style Core/Request Core/JSON Core/DOMReady
...
};}).call(this);var Event=new Type("Event",function(a,i){if(!i){i=window;}var o=i.document;a=a||i.event;if(a.$extended){return a;}this.$extended=true;var n=a.type,k=a.target||a.srcElement,m={},c={},q=null,h,l,b,p;
