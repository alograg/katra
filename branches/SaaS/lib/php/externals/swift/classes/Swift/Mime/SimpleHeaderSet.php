...
class Swift_Mime_SimpleHeaderSet implements Swift_Mime_HeaderSet
{
    ...
    public function addMailboxHeader($name, $addresses = NULL)
    {
        $this->_storeHeader($name,
                        $this->_factory
                                ->createMailboxHeader($name, $addresses));
    }
    ...
    public function addDateHeader($name, $timestamp = NULL)
    {
        $this->_storeHeader($name,
                        $this->_factory
                                ->createDateHeader($name, $timestamp));
    }
    ...
    private function _sortHeaders($a, $b)
    {
        $lowerA = strtolower($a);
        $lowerB = strtolower($b);
        $aPos = array_key_exists($lowerA, $this->_order) ? $this->_order[$lowerA]
                : -1;
        $bPos = array_key_exists($lowerB, $this->_order) ? $this->_order[$lowerB]
                : -1;
